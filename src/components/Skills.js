  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="Blockchain" x="15vw" y="-12vw" />
        <Skill name="Web3.js" x="32vw" y="-5vw" />
        <Skill name="Ethereum" x="-25vw" y="18vw" />
        <Skill name="Tailwind CSS" x="18vw" y="18vw" />
        <Skill name="Stacks" x="0vw" y="-20vw" />
        <Skill name="Chromia" x="-32vw" y="4vw" />
      </div>
    </>
  );
};
